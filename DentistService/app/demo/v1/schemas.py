...
definitions = {'definitions': {'dentist': {'type': 'object', 'properties': {'name': {'type': 'string'}, 'location': {'type': 'string'}, 'specialisation': {'type': 'string'}}}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentist', 'GET'): {200: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('dentist_dentistName', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/dentist'}}, 404: {'headers': None, 'schema': None}},
}
