...
definitions = {'definitions': {'booking': {'type': 'object', 'properties': {'appointmentTime': {'type': 'string'}, 'doctorName': {'type': 'string'}, 'patientName': {'type': 'string'}}}}, 'parameters': {}}

validators = {
    ('timeslot', 'PUT'): {'json': {'$ref': '#/definitions/booking'}},
    ('timeslot', 'DELETE'): {'json': {'$ref': '#/definitions/booking'}},
}

filters = {
    ('timeslot', 'PUT'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/booking'}}, 400: {'headers': None, 'schema': None}},
    ('timeslot', 'DELETE'): {204: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('timeslot_dentistName', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/booking'}}}, 404: {'headers': None, 'schema': None}},
}
